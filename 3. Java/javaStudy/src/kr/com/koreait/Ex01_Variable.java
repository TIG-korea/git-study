...
//		USER_AGE = 25;
		...
		int iNumber = (int)lNumber;	//8btyte를 강제로 4byte로 변경 
		...
		System.out.printf("Pi_double의 값은  %f 입니다. %n ", pi_double);
		...
		// 		> 파일 상단에 import java.tull.Scanner;
		// 2. 객체 생성하기
		...
		// 또는 Ctrl + Shift + O를 눌러서 import 하는 방법 (이클립스 기준)  
		Scanner sc = new Scanner(System.in); 
