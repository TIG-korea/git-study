...
public class Ex02_Operator {
	...
	public static void main(String[] args) {
		// 연산자 (Operator)
		// 	- 수학적 계산이나 데이터 처릴르 수행하기 위해 사용하는 기호 또는 기호 조합
		...
		// 2. 증강 연산자
		// 	- 피 연산자를 1 증강 또는 1 감소 시킴 
		
		int number = 10;
		System.out.println(number); // 10
		number++; // 변수 number 1 증가 -> 11
		...
		// a != b : a와 b가 같지 않다
		// a < b : a와 b보다 작다 (미만)
		// a <= b : a와 b보다 작거나 같다 (이하)
		// a > b : a와 b보다 크다 (초과)
		// a >= b : a와 b보다 크거나 같다 (이상)
		String str1 = "ABC";
		...
		System.out.println(str1 == str2); // 주소값 비교이기 떄문에 fasle
		System.out.println(str1.equals(str2)); // 문자열 비교이기 떄문에 true 
		...
		// 4. 논지 부정 연산자
		// 	- true면 false를 반환하고 false면 true 반환
