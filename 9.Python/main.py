...
result = list_remove.remove("green") # 삭제 요소 반환 안함
print(result)
print(list_remove)
print("============================")
...
#   - 원본이 변경됨
#   - 기본 동작 : 오름차순
list_sort = [1, 6, 7, 3, 2, 4]
list_sort.sort()
print(list_sort)

list_sort.sort(reverse=True)  # 내림차순
print(list_sort)
...
names[0] = "a" # 불변법칙떄문에 추가 변경 삭제 안됨
print("============================")

tuple_alphabet = ("a","b","c", "b", "c","b")
print(tuple_alphabet.count("a")) # 요소의 갯수
print(tuple_alphabet.index("c")) # 요소의 인덱스(가장 앞에 있는)

#------------------------------------
# 세트(set)
#   - 순서가 없고 중복을 허용하지 않는 자료구조
numbers = [1,6,2,5,5,7,8,1,2,62,3,]

set_numbers = set(numbers) # set으로 변환 - 중복 제거
print("set 변환 ", set_numbers)

list_numbers = list(set_numbers) # list변환
...
print(sports_star.keys()) #딕셔너리의 키
...
# [('축구', '박지성') ('야구', '이정후'), ('피겨스케이팅', '김연아'), ('수영', '박태환')]
